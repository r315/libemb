...
enum {
    ...
    DMA_REQ_MAT0_0 = DMA_REQ_UART0_TX,
    DMA_REQ_MAT0_1 = DMA_REQ_UART0_RX,
    DMA_REQ_MAT1_0 = DMA_REQ_UART1_TX,
    DMA_REQ_MAT1_1 = DMA_REQ_UART1_RX,
    DMA_REQ_MAT2_0 = DMA_REQ_UART2_TX,
    DMA_REQ_MAT2_1 = DMA_REQ_UART2_RX,
    DMA_REQ_MAT3_0 = DMA_REQ_UART3_TX,
    DMA_REQ_MAT3_1 = DMA_REQ_UART3_RX,
};
