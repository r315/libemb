...
typedef enum i2cx_e i2cbusnum_t;
...
typedef enum i2c_status {
    I2C_OK = 0,            /*!< no error */
    I2C_ERROR_STEP_1,      /*!< step 1 error */
    I2C_ERROR_STEP_2,      /*!< step 2 error */
    I2C_ERROR_STEP_3,      /*!< step 3 error */
    I2C_ERROR_STEP_4,      /*!< step 4 error */
    I2C_ERROR_STEP_5,      /*!< step 5 error */
    I2C_ERROR_STEP_6,      /*!< step 6 error */
    I2C_ERROR_STEP_7,      /*!< step 7 error */
    I2C_ERROR_STEP_8,      /*!< step 8 error */
    I2C_ERROR_STEP_9,      /*!< step 9 error */
    I2C_ERROR_STEP_10,     /*!< step 10 error */
    I2C_ERROR_STEP_11,     /*!< step 11 error */
    I2C_ERROR_STEP_12,     /*!< step 12 error */
    I2C_ERROR_START,       /*!< start error */
    I2C_ERROR_ADDR10,      /*!< addr10 error */
    I2C_ERROR_ADDR,        /*!< addr error */
    I2C_ERROR_STOP,        /*!< stop error */
    I2C_ERROR_ACKFAIL,     /*!< ackfail error */
    I2C_ERROR_TIMEOUT,     /*!< timeout error */
    I2C_ERROR_INTERRUPT,   /*!< interrupt error */
} i2c_status_t;
...
static hi2c_t hi2ca = {I2C0}, hi2cb = {I2C1};
...
uint32_t I2C_Init(i2cbus_t *i2cbus)
{
    ...
    i2c_init_gpio(i2cbus->bus_num);

    i2c_deinit(hi2c->periph);
    /* configure I2C clock */
    i2c_clock_config(hi2c->periph, i2cbus->speed, I2C_DTCY_2);
    /* configure I2C address */
    i2c_mode_addr_config(hi2c->periph, I2C_I2CMODE_ENABLE, I2C_ADDFORMAT_7BITS, I2Cx_OWN_ADDRESS7);
    /* enable I2C0 */
    i2c_enable(hi2c->periph);
...
{
    return i2c_master_transmit(*(uint32_t*)i2cbus->handle, addr, data, size, 1000) != I2C_OK ? 0 : size;
}
