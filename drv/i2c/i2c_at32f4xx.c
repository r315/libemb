...
uint32_t I2C_Write(i2cbus_t *i2cbus, const uint8_t *data, uint32_t size){
    I2C_StatusType res = I2C_Master_Transmit(i2cbus->peripheral, i2cbus->addr, (uint8_t*)data, size, 1000);
